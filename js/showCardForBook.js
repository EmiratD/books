import showInfoBook from "./infoBook.js";

const showCardForBook = ({ author, name, img, id }, bord, url, token) => {
  ...
  bookCard.addEventListener("click", () => {
    showInfoBook(url, token, id, bord);
  });

  bord.appendChild(bookCard);
};

export default showCardForBook;